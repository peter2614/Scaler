...
import { calculateProfitMargin, calculateWeightedProfitMargin, clickRate, recommendedBudget, getWeightedAvg } from './../utils/utils';
  ...
  return (
    <Table bordered responsive>
      ...
      <tbody>
        ...
        <tr>
          <th>Weighted Return on Ad Spend</th>
          <td>
